...
import com.sknop.kafka.connect.transforms.Cast;
...
public class CastTest {
    ...
    public void castWholeRecordKeyWithSchema() {
        ...
        assertEquals(Type.INT8, transformed.keySchema().type());
    ...
    public void castWholeRecordValueWithSchemaInt8() {
        ...
        assertEquals(Type.INT8, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaInt16() {
        ...
        assertEquals(Type.INT16, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaInt32() {
        ...
        assertEquals(Type.INT32, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaInt64() {
        ...
        assertEquals(Type.INT64, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaFloat32() {
        ...
        assertEquals(Type.FLOAT32, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaFloat64() {
        ...
        assertEquals(Type.FLOAT64, transformed.valueSchema().type());
        assertEquals(42., transformed.value());
    }
    ...
    public void castWholeRecordValueWithSchemaBooleanTrue() {
        ...
        assertEquals(Type.BOOLEAN, transformed.valueSchema().type());
    ...
    public void castWholeRecordValueWithSchemaString() {
        ...
        assertEquals(Type.STRING, transformed.valueSchema().type());
        assertEquals("42", transformed.value());
    }
    ...
    public void castFieldsWithSchema() {
        ...
        xformValue.configure(Collections.singletonMap(Cast.SPEC_CONFIG,
                "int8:int16,int16:int32,int32:int64,int64:boolean,float32:float64,float64:boolean,boolean:int8,string:int32,bigdecimal:string,date:string,optional:int32,bytes:string"));
